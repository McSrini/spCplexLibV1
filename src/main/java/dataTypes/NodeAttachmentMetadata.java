...
public class NodeAttachmentMetadata implements Serializable {
    ...
    //
    //note the default value, which is overwritten with the subtree ID when an active subtree is asked to return all its leaf node meta data
    public String treeGuid = ORIGINAL_PROBLEM_TREE_GUID;
